...
/**
 * Brand icons. lucide-react dropped `Github` / `Linkedin` in recent versions,
 * so we ship minimal, accessible SVG marks here. Sizing matches lucide
 * conventions (currentColor + w/h controllable via className).
 */
